...
const CandlestickChart = ({ children, data, coinId, height = 360, initialPeriod = 'daily' }: CandlestickChartProps) => {
    const chartConatainerRef = useRef<HTMLDivElement | null>(null);
    ...
    useEffect(() => {
        const container = chartConatainerRef.current;
        if (!container) return;
    ...
    return (
        <div id="candlestick-chart">
            ...
            <div ref={chartConatainerRef} className='chart' style={{ height }} />
        </div>
    );
};
